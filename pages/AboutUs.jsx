...
const AboutUs = () => {
  return (
    <Fragment>
      <div className="relative w-full overflow-hidden text-white h-fit bg-dark-primary">
        <div className="absolute z-50 scale-50 cursor-pointer xl:top-10 xl:left-10 sm:scale-75 lg:scale-100 lg:top-3 lg:left-3">
          <Link href="/">
            <a>
        ...
        <h1 className="text-3xl text-center text-white md:text-6xl lg:text-8xl font-primary pt-28">
          SCHEMATICS
        </h1>
        ...
        <div className="flex flex-col items-center justify-center mb-12 xl:flex-row md:p-14 md:pt-0 lg:p-28 lg:pt-14">
          ...
          <div className="mt-5 xl:mt-0 sm:w-[300px] md:w-[450px] lg:w-[600px] h-[210px] md:h-[315px] lg:h-[420px] bg-gradient-to-t from-amber-300 to-color rounded-xl active:bg-none z-50">
            <iframe
              className="w-full h-full opacity-80 active:opacity-100 active:bg-none rounded-xl"
              frameBorder={0}
              src="https://www.youtube.com/embed/gWdWqKMIuug"
            ></iframe>
          </div>
        </div>
        <div className="absolute scale-50 -translate-x-20 -translate-y-5 select-none -left-52 -bottom-60 sm:scale-75 lg:scale-100 sm:-translate-x-16 lg:translate-x-0">
          <Image
            width={692}
            height={457}
