      ...
      <main className='bg-dark-primary overflow-x-hidden'>
        ...
        >
          <div className='flex flex-col md:flex-row w-5/6 mx-auto item-center gap-10 md:gap-10 pt-4 md:pt-0'>
            ...
            <div className='flex items-center justify-center h-64 select-none sm:px-12 xl:h-auto xl:w-1/2'>
              <iframe
                className='w-full h-1/2 opacity-80 active:opacity-100 active:bg-none'
                frameBorder={0}
